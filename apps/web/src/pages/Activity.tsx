    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-4 gap-4 animate-fade-up delay-100">
                <SummaryCard label="Total Events" value={events.length} accent="bg-gray-500" />
                <SummaryCard label="Status Changes" value={statusChanges} accent="bg-blue-500" />
                <SummaryCard label="Task Events" value={taskEvents} accent="bg-purple-500" />
                <SummaryCard label="Tour Events" value={tourEvents} accent="bg-amber-400" />
            </div>
